...
const Success = () => {
	...
	return (
		<div className="myDiv text-center display-4 min-h-screen pt-20">
			{isLoading ? (
				<div className="text-center">
					<div role="status" className="mx-auto inline-block">
						<svg
							aria-hidden="true"
							className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-yellow-400 mb-6"
							viewBox="0 0 100 101"
							fill="none"
